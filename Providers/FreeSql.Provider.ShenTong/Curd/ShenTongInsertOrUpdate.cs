...
namespace FreeSql.ShenTong.Curd
{
    ...
    class ShenTongInsertOrUpdate<T1> : Internal.CommonProvider.InsertOrUpdateProvider<T1> where T1 : class
    {
        public ShenTongInsertOrUpdate(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression)
