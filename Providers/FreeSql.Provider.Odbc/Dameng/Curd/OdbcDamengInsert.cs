...
namespace FreeSql.Odbc.Dameng
{
    ...
    class OdbcDamengInsert<T1> : Internal.CommonProvider.InsertProvider<T1> where T1 : class
    {
        public OdbcDamengInsert(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression)
