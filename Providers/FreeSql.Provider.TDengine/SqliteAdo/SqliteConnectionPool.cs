...
namespace FreeSql.TDengine
{
    ...
    class TDengineConnectionPool : ObjectPool<DbConnection>
    {

        internal Action availableHandler;
        internal Action unavailableHandler;

        public TDengineConnectionPool(string name, string connectionString, Action availableHandler, Action unavailableHandler) : base(null)
        {
            this.availableHandler = availableHandler;
            this.unavailableHandler = unavailableHandler;
            policy = new TDengineConnectionPoolPolicy
            {
                _pool = this,
                Name = name
            };
        ...
        {
            if (exception != null && exception is TaosException)
            {
        ...
        internal TDengineConnectionPoolPolicy policy;
    }

    class TDengineConnectionPoolPolicy : IPolicy<DbConnection>
    {

        internal TDengineConnectionPool _pool;
        public string Name { get; set; } = "TDengine TDengineConnection 对象池";
        ...
        {
            var conn = new TaosConnection(_connectionString);
            return conn;
        }
