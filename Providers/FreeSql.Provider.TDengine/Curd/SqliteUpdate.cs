...
namespace FreeSql.TDengine.Curd
{
    ...
    class TDengineUpdate<T1> : Internal.CommonProvider.UpdateProvider<T1> where T1 : class
    {

        public TDengineUpdate(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression, object dywhere)
