...
namespace FreeSql.KingbaseES
{
    ...
    class KingbaseESUpdate<T1> : Internal.CommonProvider.UpdateProvider<T1> where T1 : class
    {

        public KingbaseESUpdate(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression, object dywhere)
