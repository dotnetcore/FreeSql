...
namespace FreeSql.KingbaseES
{
    ...
    class KingbaseESInsert<T1> : Internal.CommonProvider.InsertProvider<T1> where T1 : class
    {
        public KingbaseESInsert(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression)
