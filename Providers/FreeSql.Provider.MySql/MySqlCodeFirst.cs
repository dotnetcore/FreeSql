                        ...
                        foreach (var tbcol in tb.ColumnsByPosition)
                        {
                                ...
                                string.IsNullOrEmpty(tbcol.Attribute.OldName) == false && tbstruct.TryGetValue(tbcol.Attribute.OldName, out tbstructcol))
                            {
                                ...
                                isCommentChanged)
                                {
                                    ...
                                    if (tbcol.Attribute.IsPrimary == true) sbalter.Append(existsPrimary == null ? "" : ", DROP PRIMARY KEY").Append(", ADD PRIMARY KEY(").Append(_commonUtils.QuoteSqlName(tbcol.Attribute.Name)).Append(")");
                                    sbalter.Append(";\r\n");
                                }
