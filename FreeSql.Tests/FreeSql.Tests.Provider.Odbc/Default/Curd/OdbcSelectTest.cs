...
namespace FreeSql.Tests.Odbc.Default
{
    public class OdbcSelectTest
    {
        ...
        {
            //OneToOne、ManyToOne
            var t0 = g.odbc.Select<Tag>().Where(a => a.Parent.Parent.Name == "粤语").ToSql();
            ...
            //OneToMany
            var t1 = g.odbc.Select<Tag>().Where(a => a.Tags.AsSelect().Any(t => t.Parent.Id == 10)).ToSql();
        ...
        public void Lazy()
        {
            var tags = g.odbc.Select<Tag>().Where(a => a.Parent.Name == "xxx")
                .LeftJoin(a => a.Parent_id == a.Parent.Id)
                .ToSql();

            var songs = g.odbc.Select<Song>().Limit(10).ToList();
        ...
        public void ToDataTable()
        {
            ...
            Assert.Equal(1, g.odbc.Insert<Topic>().AppendData(items.First()).ExecuteAffrows());
            Assert.Equal(10, g.odbc.Insert<Topic>().AppendData(items).ExecuteAffrows());

            //items = Enumerable.Range(0, 9989).Select(a => new Topic { Title = "newtitle" + a, CreateTime = DateTime.Now }).ToList();
            //;
            //Assert.Equal(9989, g.odbc.Insert<Topic>(items).NoneParameter().ExecuteAffrows());
...
WHERE (((cast(a.[Id] as nvarchar)) in (SELECT b.[Title] 
	FROM [tb_topic22] b)))", subquery);
        ...
        public void Include_OneToMany2()
        {
            ...
            model2.id = (int)g.odbc.Insert(model2).ExecuteIdentity();
        ...
        public void Include_OneToChilds()
        {
            ...
            tag1.Id = (int)g.odbc.Insert(tag1).ExecuteIdentity();
            var tag1_1 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_1.Id = (int)g.odbc.Insert(tag1_1).ExecuteIdentity();
            var tag1_2 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_2.Id = (int)g.odbc.Insert(tag1_2).ExecuteIdentity();
            ...
            tag2.Id = (int)g.odbc.Insert(tag2).ExecuteIdentity();
            var tag2_1 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_1.Id = (int)g.odbc.Insert(tag2_1).ExecuteIdentity();
            var tag2_2 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_2.Id = (int)g.odbc.Insert(tag2_2).ExecuteIdentity();

            var tags0 = g.odbc.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var tags1 = g.odbc.Select<Tag>()
        ...
        public void Include_ManyToMany()
        {
            ...
            tag3.Id = (int)g.odbc.Insert(tag3).ExecuteIdentity();
            ...
            song1.Id = (int)g.odbc.Insert(song1).ExecuteIdentity();
            var song2 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song2.Id = (int)g.odbc.Insert(song2).ExecuteIdentity();
            var song3 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song3.Id = (int)g.odbc.Insert(song3).ExecuteIdentity();

            g.odbc.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.odbc.Insert(new Song_tag { Song_id = song2.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.odbc.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.odbc.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.odbc.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.odbc.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag3.Id }).ExecuteAffrows();

            var songs1 = g.odbc.Select<Song>()
                .IncludeMany(a => a.Tags)
            ...
            var tags3 = g.odbc.Select<Song_tag>()
            ...
            var songs11 = g.odbc.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            ...
            var songs22 = g.odbc.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.odbc.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
