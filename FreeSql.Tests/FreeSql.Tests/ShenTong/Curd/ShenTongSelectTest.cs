...
{
    public class ShenTongSelectTest
    {
        ...
        {
            //OneToOne、ManyToOne
            var t0 = g.shentong.Select<Tag>().Where(a => a.Parent.Parent.Name == "粤语").ToSql();
            ...
            //OneToMany
            var t1 = g.shentong.Select<Tag>().Where(a => a.Tags.AsSelect().Any(t => t.Parent.Id == 10)).ToSql();
        ...
        public void Lazy()
        {
            var tags = g.shentong.Select<Tag>().Where(a => a.Parent.Name == "xxx")
                .LeftJoin(a => a.Parent_id == a.Parent.Id)
                .ToSql();

            var songs = g.shentong.Select<Song>().Limit(10).ToList();
        }
        ...
        public void ToDataTable()
        {
            ...
            Assert.Single(g.shentong.Insert<Topic>().AppendData(items.First()).ExecuteInserted());
            Assert.Equal(10, g.shentong.Insert<Topic>().AppendData(items).ExecuteInserted().Count);

            //items = Enumerable.Range(0, 9989).Select(a => new Topic { Title = "newtitle" + a, CreateTime = DateTime.Now }).ToList();
            //Assert.Equal(9989, g.shentong.Insert<Topic>(items).ExecuteAffrows());
        ...
        public void ToList()
        {
            ...
            var t1 = g.shentong.Select<TestInfo>().Where("").Where(a => a.Id > 0).Skip(100).Limit(200).ToSql();
            var t2 = g.shentong.Select<TestInfo>().As("b").Where("").Where(a => a.Id > 0).Skip(100).Limit(200).ToSql();
            ...
            //g.shentong.Select<TestInfo, TestTypeInfo, TestTypeParentInfo>().Join((a, b, c) => new Model.JoinResult3(
            ...
            var ttt122 = g.shentong.Select<TestTypeParentInfo>().Where(a => a.Id > 0).ToSql();
            var sql5 = g.shentong.Select<TestInfo>().From<TestTypeInfo, TestTypeParentInfo>((s, b, c) => s).Where((a, b, c) => a.Id == b.ParentId).ToSql();
            var t11112 = g.shentong.Select<TestInfo>().ToList(a => new
            {
                a.Id,
                a.Title,
                a.Type,
            ...
            var t100 = g.shentong.Select<TestInfo>().Where("").Where(a => a.Id > 0).Skip(100).Limit(200).ToList();
            var t101 = g.shentong.Select<TestInfo>().As("b").Where("").Where(a => a.Id > 0).Skip(100).Limit(200).ToList();


            var t1111 = g.shentong.Select<TestInfo>().ToList(a => new { a.Id, a.Title, a.Type });

            var t2222 = g.shentong.Select<TestInfo>().ToList(a => new { a.Id, a.Title, a.Type.Name });

            g.shentong.Insert<TestGuidIdToList>().AppendData(new TestGuidIdToList()).ExecuteAffrows();
            var testGuidId5 = g.shentong.Select<TestGuidIdToList>().ToList();
            var testGuidId6 = g.shentong.Select<TestGuidIdToList>().ToList(a => a.id);
            ...
            var ddd = g.shentong.Select<District>().LeftJoin(d => d.ParentCode == d.Parent.Code).ToTreeList();
            Assert.Single(ddd);
        ...
        public void ToDictionary()
        {
            ...
            var repo = g.shentong.GetRepository<Topic>();
        ...
        public void GroupBy()
        {
            ...
            var testpid1 = g.shentong.Insert<TestTypeInfo>().AppendData(new TestTypeInfo { Name = "Name" + DateTime.Now.ToString("yyyyMMddHHmmss") }).ExecuteIdentity();
            g.shentong.Insert<TestInfo>().AppendData(new TestInfo { Title = "Title" + DateTime.Now.ToString("yyyyMMddHHmmss"), CreateTime = DateTime.Now, TypeGuid = (int)testpid1 }).ExecuteAffrows();
...
WHERE ((((a.""ID"")::text) in (SELECT b.""TITLE"" 
    FROM ""TB_TOPIC"" b)))", subquery);
        ...
        public void Include_OneToMany()
        {
            ...
            var at22 = g.shentong.Select<TestInclude_OneToManyModel1>()
                .IncludeMany(a => a.model2.childs.Take(1).Where(m3 => m3.model2111Idaaa == a.model2.model2id).Select(m3 => new TestInclude_OneToManyModel3 { id = m3.id }),
        ...
        public void Include_OneToMany2()
        {
            ...
            model2.id = (int)g.shentong.Insert(model2).ExecuteIdentity();
            ...
            var at1 = g.shentong.Select<TestInclude_OneToManyModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
            ...
            var at11 = g.shentong.Select<TestInclude_OneToManyModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
        ...
        public void Include_OneToChilds()
        {
            ...
            tag1.Id = (int)g.shentong.Insert(tag1).ExecuteIdentity();
            var tag1_1 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_1.Id = (int)g.shentong.Insert(tag1_1).ExecuteIdentity();
            var tag1_2 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_2.Id = (int)g.shentong.Insert(tag1_2).ExecuteIdentity();
            ...
            tag2.Id = (int)g.shentong.Insert(tag2).ExecuteIdentity();
            var tag2_1 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_1.Id = (int)g.shentong.Insert(tag2_1).ExecuteIdentity();
            var tag2_2 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_2.Id = (int)g.shentong.Insert(tag2_2).ExecuteIdentity();

            var tags0 = g.shentong.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var tags1 = g.shentong.Select<Tag>()
            ...
            var tags2 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags,
            ...
            var tags3 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags,
            ...
            var tags11 = g.shentong.Select<Tag>()
            ...
            var tags22 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var atags0 = g.shentong.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var atags1 = g.shentong.Select<Tag>()
            ...
            var atags2 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
                    then => then.Include(a => a.Parent).IncludeMany(a => a.Songs))
                .Include(a => a.Parent)
                .IncludeMany(a => a.Songs.Select(b => new Song { Id = b.Id, Title = b.Title }))
            ...
            var atags3 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags11 = g.shentong.Select<Tag>()
            ...
            var atags22 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.shentong.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
        ...
        public void Include_ManyToMany()
        {
            ...
            tag3.Id = (int)g.shentong.Insert(tag3).ExecuteIdentity();
            ...
            song1.Id = (int)g.shentong.Insert(song1).ExecuteIdentity();
            var song2 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song2.Id = (int)g.shentong.Insert(song2).ExecuteIdentity();
            var song3 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song3.Id = (int)g.shentong.Insert(song3).ExecuteIdentity();

            g.shentong.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.shentong.Insert(new Song_tag { Song_id = song2.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.shentong.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.shentong.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.shentong.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.shentong.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag3.Id }).ExecuteAffrows();

            var songs1 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags)
            ...
            var songs2 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags,
            ...
            var tags3 = g.shentong.Select<Song_tag>()
            ...
            var songs11 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            ...
            var songs22 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.shentong.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            new List<Song>(new[] { song1, song2, song3 }).IncludeMany(g.shentong, a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }));

            var asongs1 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            Assert.Equal(3, songs1.Count);
            ...
            var asongs2 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags3 = g.shentong.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            var asongs11 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            Assert.Equal(3, songs11.Count);
            ...
            var asongs22 = g.shentong.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.shentong.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
        ...
        {
            g.shentong.Select<ToDel1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.shentong.Select<ToDel1Pk>().Count());
            g.shentong.Insert(new[] {
            ...
            Assert.Equal(2, g.shentong.Select<ToDel1Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.shentong.Select<ToDel1Pk>().Count());
            Assert.Equal(3, g.shentong.Select<ToDel1Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.shentong.Select<ToDel2Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.shentong.Select<ToDel2Pk>().Count());
            g.shentong.Insert(new[] {
            ...
            Assert.Equal(2, g.shentong.Select<ToDel2Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.shentong.Select<ToDel2Pk>().Count());
            Assert.Equal(3, g.shentong.Select<ToDel2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.shentong.Select<ToDel3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.shentong.Select<ToDel3Pk>().Count());
            g.shentong.Insert(new[] {
            ...
            Assert.Equal(2, g.shentong.Select<ToDel3Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.shentong.Select<ToDel3Pk>().Count());
            Assert.Equal(3, g.shentong.Select<ToDel3Pk>().Where(a => a.name.StartsWith("nick")).Count());
        }
        ...
        {
            g.shentong.Select<ToUpd1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.shentong.Select<ToUpd1Pk>().Count());
            g.shentong.Insert(new[] {
            ...
            Assert.Equal(2, g.shentong.Select<ToUpd1Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.shentong.Select<ToUpd1Pk>().Count());
            Assert.Equal(5, g.shentong.Select<ToUpd1Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.shentong.Select<ToUpd2Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.shentong.Select<ToUpd2Pk>().Count());
            g.shentong.Insert(new[] {
            ...
            Assert.Equal(2, g.shentong.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.shentong.Select<ToUpd2Pk>().Count());
            Assert.Equal(5, g.shentong.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.shentong.Select<ToUpd3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.shentong.Select<ToUpd3Pk>().Count());
            g.shentong.Insert(new[] {
            ...
            Assert.Equal(2, g.shentong.Select<ToUpd3Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.shentong.Select<ToUpd3Pk>().Count());
            Assert.Equal(5, g.shentong.Select<ToUpd3Pk>().Where(a => a.name.StartsWith("nick")).Count());
        }
