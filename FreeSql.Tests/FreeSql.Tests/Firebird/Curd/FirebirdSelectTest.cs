...
namespace FreeSql.Tests.Firebird
{
    public class FirebirdSelectTest
    {
        ...
        public void Lazy()
        {
            var tags = g.firebird.Select<Tag>().Where(a => a.Parent.Name == "xxx")
                .LeftJoin(a => a.Parent_id == a.Parent.Id)
                .ToSql();

            var songs = g.firebird.Select<Song>().Limit(10).ToList();
        }
        ...
        public void ToDataTable()
        {
            ...
            Assert.Equal(11, g.firebird.Insert<TopicInserts>().AppendData(items).ExecuteAffrows());
        ...
        public void ToList()
        {
            ...
            g.firebird.Insert<TestGuidIdToList>().AppendData(new TestGuidIdToList()).ExecuteAffrows();
            var testGuidId5 = g.firebird.Select<TestGuidIdToList>().ToList();
            var testGuidId6 = g.firebird.Select<TestGuidIdToList>().ToList(a => a.id);
            ...
            var ddd = g.firebird.Select<District>().LeftJoin(d => d.ParentCode == d.Parent.Code).ToTreeList();
            Assert.Single(ddd);
        ...
        public void GroupBy()
        {
            ...
            var testpid1 = g.firebird.Insert<TestTypeInfo>().AppendData(new TestTypeInfo { Name = "Name" + DateTime.Now.ToString("yyyyMMddHHmmss") }).ExecuteIdentity();
            g.firebird.Insert<TestInfo>().AppendData(new TestInfo { Title = "Title" + DateTime.Now.ToString("yyyyMMddHHmmss"), CreateTime = DateTime.Now, TypeGuid = (int)testpid1 }).ExecuteAffrows();
...
WHERE (((cast(a.""ID"" as blob sub_type 1)) in (SELECT b.""TITLE"" 
    FROM ""TB_TOPIC22"" b)))", subquery);
        ...
        public void Include_OneToMany2()
        {
            ...
            var at1 = g.firebird.Select<TiOtmModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
            ...
            var at11 = g.firebird.Select<TiOtmModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
        ...
        public void Include_OneToChilds()
        {
            ...
            var tags0 = g.firebird.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var tags1 = g.firebird.Select<Tag>()
            ...
            var tags2 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags,
            ...
            var tags3 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags,
            ...
            var tags11 = g.firebird.Select<Tag>()
            ...
            var tags22 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var atags0 = g.firebird.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var atags1 = g.firebird.Select<Tag>()
            ...
            var atags2 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
                    then => then.Include(a => a.Parent).IncludeMany(a => a.Songs))
                .Include(a => a.Parent)
                .IncludeMany(a => a.Songs.Select(b => new Song { Id = b.Id, Title = b.Title }))
            ...
            var atags3 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags11 = g.firebird.Select<Tag>()
            ...
            var atags22 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.firebird.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
        ...
        public void Include_ManyToMany()
        {
            ...
            var songs1 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags)
            ...
            var songs2 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags,
            ...
            var tags3 = g.firebird.Select<Song_tag>()
            ...
            var songs11 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            ...
            var songs22 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.firebird.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            new List<Song>(new[] { song1, song2, song3 }).IncludeMany(g.firebird, a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }));

            var asongs1 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            Assert.Equal(3, songs1.Count);
            ...
            var asongs2 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags3 = g.firebird.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            var asongs11 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            Assert.Equal(3, songs11.Count);
            ...
            var asongs22 = g.firebird.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.firebird.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
        ...
        {
            g.firebird.Select<ToDel1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.firebird.Select<ToDel1Pk>().Count());
            ...
            Assert.Equal(2, g.firebird.Select<ToDel1Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.firebird.Select<ToDel1Pk>().Count());
            Assert.Equal(3, g.firebird.Select<ToDel1Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.firebird.Select<ToDel2Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.firebird.Select<ToDel2Pk>().Count());
            g.firebird.Insert(new[] {
            ...
            Assert.Equal(2, g.firebird.Select<ToDel2Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.firebird.Select<ToDel2Pk>().Count());
            Assert.Equal(3, g.firebird.Select<ToDel2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.firebird.Select<ToDel3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.firebird.Select<ToDel3Pk>().Count());
            g.firebird.Insert(new[] {
            ...
            Assert.Equal(2, g.firebird.Select<ToDel3Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.firebird.Select<ToDel3Pk>().Count());
            Assert.Equal(3, g.firebird.Select<ToDel3Pk>().Where(a => a.name.StartsWith("nick")).Count());
        }
        ...
        {
            g.firebird.Select<ToUpd1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.firebird.Select<ToUpd1Pk>().Count());
            g.firebird.Insert(new[] {
            ...
            Assert.Equal(2, g.firebird.Select<ToUpd1Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.firebird.Select<ToUpd1Pk>().Count());
            Assert.Equal(5, g.firebird.Select<ToUpd1Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.firebird.Select<ToUpd2Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.firebird.Select<ToUpd2Pk>().Count());
            g.firebird.Insert(new[] {
            ...
            Assert.Equal(2, g.firebird.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.firebird.Select<ToUpd2Pk>().Count());
            Assert.Equal(5, g.firebird.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.firebird.Select<ToUpd3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.firebird.Select<ToUpd3Pk>().Count());
            g.firebird.Insert(new[] {
            ...
            Assert.Equal(2, g.firebird.Select<ToUpd3Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.firebird.Select<ToUpd3Pk>().Count());
            Assert.Equal(5, g.firebird.Select<ToUpd3Pk>().Where(a => a.name.StartsWith("nick")).Count());
        }
