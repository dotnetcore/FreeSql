...
{
    public class KingbaseESSelectTest
    {
        ...
        {
            //OneToOne、ManyToOne
            var t0 = g.kingbaseES.Select<Tag>().Where(a => a.Parent.Parent.Name == "粤语").ToSql();
            ...
            //OneToMany
            var t1 = g.kingbaseES.Select<Tag>().Where(a => a.Tags.AsSelect().Any(t => t.Parent.Id == 10)).ToSql();
        ...
        public void Lazy()
        {
            var tags = g.kingbaseES.Select<Tag>().Where(a => a.Parent.Name == "xxx")
                .LeftJoin(a => a.Parent_id == a.Parent.Id)
                .ToSql();

            var songs = g.kingbaseES.Select<Song>().Limit(10).ToList();
        }
        ...
        public void ToDataTable()
        {
            ...
            //Assert.Equal(1, g.kingbaseES.Insert<TopicInserts>().AppendData(items.First()).ExecuteAffrows());
            Assert.Equal(11, g.kingbaseES.Insert<TopicInserts>().AppendData(items).ExecuteAffrows());

            //items = Enumerable.Range(0, 9989).Select(a => new TopicInserts { Title = "newtitle" + a, CreateTime = DateTime.Now }).ToList();
            //Assert.Equal(9989, g.kingbaseES.Insert<TopicInserts>(items).ExecuteAffrows());
        ...
        public void ToList()
        {
            ...
            var testDto2255 = select.LeftJoin(a => a.Type.Guid == a.TypeGuid223).Limit(10).ToList<TestDto2>();

            g.kingbaseES.Insert<TestGuidIdToList>().AppendData(new TestGuidIdToList()).ExecuteAffrows();
            var testGuidId5 = g.kingbaseES.Select<TestGuidIdToList>().ToList();
            var testGuidId6 = g.kingbaseES.Select<TestGuidIdToList>().ToList(a => a.id);
            ...
            var ddd = g.kingbaseES.Select<District>().LeftJoin(d => d.ParentCode == d.Parent.Code).ToTreeList();
            Assert.Single(ddd);
        ...
        public void LeftJoin()
        {
            ...
            //���û�е�������
            query = select.LeftJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223);
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.LeftJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223 && b.Name == "xxx");
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.LeftJoin<TestTypeInfo>((a, a__Type) => a__Type.Guid == a.TypeGuid223 && a__Type.Name == "xxx").Where(a => a.Type.Parent.Id == 10);
            sql = query.ToSql().Replace("\r\n", "");
            Assert.Equal("SELECT a.\"ID\", a.\"CLICKS\", a.\"TYPEGUID\", a__Type.\"GUID\", a__Type.\"PARENTID\", a__Type.\"NAME\", a.\"TITLE\", a.\"CREATETIME\" FROM \"TB_TOPIC22\" a LEFT JOIN \"TESTTYPEINFO\" a__Type ON a__Type.\"GUID\" = a.\"TYPEGUID\" AND a__Type.\"NAME\" = 'xxx' LEFT JOIN \"TESTTYPEPARENTINFO\" a__Type__Parent ON a__Type__Parent.\"ID\" = a__Type.\"PARENTID\" WHERE (a__Type__Parent.\"ID\" = 10)", sql);
            query.ToList();
            ...
            query = select
                .LeftJoin<TestTypeInfo>((a, a__Type) => a__Type.Guid == a.TypeGuid223)
        ...
        public void InnerJoin()
        {
            ...
            //���û�е�������
            query = select.InnerJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223);
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.InnerJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223 && b.Name == "xxx");
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.InnerJoin<TestTypeInfo>((a, a__Type) => a__Type.Guid == a.TypeGuid223 && a__Type.Name == "xxx").Where(a => a.Type.Parent.Id == 10);
            sql = query.ToSql().Replace("\r\n", "");
            Assert.Equal("SELECT a.\"ID\", a.\"CLICKS\", a.\"TYPEGUID\", a__Type.\"GUID\", a__Type.\"PARENTID\", a__Type.\"NAME\", a.\"TITLE\", a.\"CREATETIME\" FROM \"TB_TOPIC22\" a INNER JOIN \"TESTTYPEINFO\" a__Type ON a__Type.\"GUID\" = a.\"TYPEGUID\" AND a__Type.\"NAME\" = 'xxx' LEFT JOIN \"TESTTYPEPARENTINFO\" a__Type__Parent ON a__Type__Parent.\"ID\" = a__Type.\"PARENTID\" WHERE (a__Type__Parent.\"ID\" = 10)", sql);
            query.ToList();
            ...
            query = select
                .InnerJoin<TestTypeInfo>((a, a__Type) => a__Type.Guid == a.TypeGuid223)
        ...
        public void RightJoin()
        {
            ...
            //���û�е�������
            query = select.RightJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223);
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.RightJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223 && b.Name == "xxx");
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.RightJoin<TestTypeInfo>((a, a__Type) => a__Type.Guid == a.TypeGuid223 && a__Type.Name == "xxx").Where(a => a.Type.Parent.Id == 10);
            sql = query.ToSql().Replace("\r\n", "");
            Assert.Equal("SELECT a.\"ID\", a.\"CLICKS\", a.\"TYPEGUID\", a__Type.\"GUID\", a__Type.\"PARENTID\", a__Type.\"NAME\", a.\"TITLE\", a.\"CREATETIME\" FROM \"TB_TOPIC22\" a RIGHT JOIN \"TESTTYPEINFO\" a__Type ON a__Type.\"GUID\" = a.\"TYPEGUID\" AND a__Type.\"NAME\" = 'xxx' LEFT JOIN \"TESTTYPEPARENTINFO\" a__Type__Parent ON a__Type__Parent.\"ID\" = a__Type.\"PARENTID\" WHERE (a__Type__Parent.\"ID\" = 10)", sql);
            query.ToList();
            ...
            query = select
                .RightJoin<TestTypeInfo>((a, a__Type) => a__Type.Guid == a.TypeGuid223)
        ...
        public void Where()
        {
            ...
            //���û�е������ԣ��򵥶������
            query = select.Where<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223 && b.Name == "typeTitle");
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.Where<TestTypeInfo>((a, b) => b.Name == "typeTitle" && b.Guid == a.TypeGuid223);
            sql = query.ToSql().Replace("\r\n", "");
        ...
        public void GroupBy()
        {
            ...
            var testpid1 = g.kingbaseES.Insert<TestTypeInfo>().AppendData(new TestTypeInfo { Name = "Name" + DateTime.Now.ToString("yyyyMMddHHmmss") }).ExecuteIdentity();
            g.kingbaseES.Insert<TestInfo>().AppendData(new TestInfo { Title = "Title" + DateTime.Now.ToString("yyyyMMddHHmmss"), CreateTime = DateTime.Now, TypeGuid = (int)testpid1 }).ExecuteAffrows();
...
WHERE ((((a.""ID"")::text) in (SELECT b.""TITLE"" 
    FROM ""TB_TOPIC22"" b)))", subquery);
        ...
        public void AsTable()
        {
            ...
            //���û�е�������
            query = select.LeftJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223).AsTable(tableRule);
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.LeftJoin<TestTypeInfo>((a, b) => b.Guid == a.TypeGuid223 && b.Name == "xxx").AsTable(tableRule);
            sql = query.ToSql().Replace("\r\n", "");
            ...
            query = select.LeftJoin<TestTypeInfo>((a, a__Type) => a__Type.Guid == a.TypeGuid223 && a__Type.Name == "xxx").Where(a => a.Type.Parent.Id == 10).AsTable(tableRule);
            sql = query.ToSql().Replace("\r\n", "");
            Assert.Equal("SELECT a.\"ID\", a.\"CLICKS\", a.\"TYPEGUID\", a__Type.\"GUID\", a__Type.\"PARENTID\", a__Type.\"NAME\", a.\"TITLE\", a.\"CREATETIME\" FROM \"TB_TOPIC22_T1\" a LEFT JOIN \"TESTTYPEINFO_T2\" a__Type ON a__Type.\"GUID\" = a.\"TYPEGUID\" AND a__Type.\"NAME\" = 'xxx' LEFT JOIN \"TESTTYPEPARENTIN_AT\" a__Type__Parent ON a__Type__Parent.\"ID\" = a__Type.\"PARENTID\" WHERE (a__Type__Parent.\"ID\" = 10)", sql);
        ...
        public void Include_OneToMany2()
        {
            ...
            model2.id = (int)g.kingbaseES.Insert(model2).ExecuteIdentity();
            ...
            var at1 = g.kingbaseES.Select<TiOtmModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
            ...
            var at11 = g.kingbaseES.Select<TiOtmModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
        ...
        public void Include_OneToChilds()
        {
            ...
            tag1.Id = (int)g.kingbaseES.Insert(tag1).ExecuteIdentity();
            var tag1_1 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_1.Id = (int)g.kingbaseES.Insert(tag1_1).ExecuteIdentity();
            var tag1_2 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_2.Id = (int)g.kingbaseES.Insert(tag1_2).ExecuteIdentity();
            ...
            tag2.Id = (int)g.kingbaseES.Insert(tag2).ExecuteIdentity();
            var tag2_1 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_1.Id = (int)g.kingbaseES.Insert(tag2_1).ExecuteIdentity();
            var tag2_2 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_2.Id = (int)g.kingbaseES.Insert(tag2_2).ExecuteIdentity();

            var tags0 = g.kingbaseES.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var tags1 = g.kingbaseES.Select<Tag>()
            ...
            var tags2 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags,
            ...
            var tags3 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags,
            ...
            var tags11 = g.kingbaseES.Select<Tag>()
            ...
            var tags22 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var atags0 = g.kingbaseES.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var atags1 = g.kingbaseES.Select<Tag>()
            ...
            var atags2 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
                    then => then.Include(a => a.Parent).IncludeMany(a => a.Songs))
                .Include(a => a.Parent)
                .IncludeMany(a => a.Songs.Select(b => new Song { Id = b.Id, Title = b.Title }))
            ...
            var atags3 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags11 = g.kingbaseES.Select<Tag>()
            ...
            var atags22 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.kingbaseES.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
        ...
        public void Include_ManyToMany()
        {
            ...
            tag3.Id = (int)g.kingbaseES.Insert(tag3).ExecuteIdentity();
            ...
            song1.Id = (int)g.kingbaseES.Insert(song1).ExecuteIdentity();
            var song2 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song2.Id = (int)g.kingbaseES.Insert(song2).ExecuteIdentity();
            var song3 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song3.Id = (int)g.kingbaseES.Insert(song3).ExecuteIdentity();

            g.kingbaseES.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.kingbaseES.Insert(new Song_tag { Song_id = song2.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.kingbaseES.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.kingbaseES.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.kingbaseES.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.kingbaseES.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag3.Id }).ExecuteAffrows();

            var songs1 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags)
            ...
            var songs2 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags,
            ...
            var tags3 = g.kingbaseES.Select<Song_tag>()
            ...
            var songs11 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            ...
            var songs22 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.kingbaseES.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            new List<Song>(new[] { song1, song2, song3 }).IncludeMany(g.kingbaseES, a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }));

            var asongs1 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            Assert.Equal(3, songs1.Count);
            ...
            var asongs2 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags3 = g.kingbaseES.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            var asongs11 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            Assert.Equal(3, songs11.Count);
            ...
            var asongs22 = g.kingbaseES.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.kingbaseES.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
        ...
        {
            g.kingbaseES.Select<ToDel1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.kingbaseES.Select<ToDel1Pk>().Count());
            g.kingbaseES.Insert(new[] {
            ...
            Assert.Equal(2, g.kingbaseES.Select<ToDel1Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.kingbaseES.Select<ToDel1Pk>().Count());
            Assert.Equal(3, g.kingbaseES.Select<ToDel1Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.kingbaseES.Select<ToDel2Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.kingbaseES.Select<ToDel2Pk>().Count());
            g.kingbaseES.Insert(new[] {
            ...
            Assert.Equal(2, g.kingbaseES.Select<ToDel2Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.kingbaseES.Select<ToDel2Pk>().Count());
            Assert.Equal(3, g.kingbaseES.Select<ToDel2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.kingbaseES.Select<ToDel3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.kingbaseES.Select<ToDel3Pk>().Count());
            g.kingbaseES.Insert(new[] {
            ...
            Assert.Equal(2, g.kingbaseES.Select<ToDel3Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.kingbaseES.Select<ToDel3Pk>().Count());
            Assert.Equal(3, g.kingbaseES.Select<ToDel3Pk>().Where(a => a.name.StartsWith("nick")).Count());
        }
        ...
        {
            g.kingbaseES.Select<ToUpd1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.kingbaseES.Select<ToUpd1Pk>().Count());
            g.kingbaseES.Insert(new[] {
            ...
            Assert.Equal(2, g.kingbaseES.Select<ToUpd1Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.kingbaseES.Select<ToUpd1Pk>().Count());
            Assert.Equal(5, g.kingbaseES.Select<ToUpd1Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.kingbaseES.Select<ToUpd2Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.kingbaseES.Select<ToUpd2Pk>().Count());
            g.kingbaseES.Insert(new[] {
            ...
            Assert.Equal(2, g.kingbaseES.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.kingbaseES.Select<ToUpd2Pk>().Count());
            Assert.Equal(5, g.kingbaseES.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.kingbaseES.Select<ToUpd3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.kingbaseES.Select<ToUpd3Pk>().Count());
            g.kingbaseES.Insert(new[] {
            ...
            Assert.Equal(2, g.kingbaseES.Select<ToUpd3Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.kingbaseES.Select<ToUpd3Pk>().Count());
            Assert.Equal(5, g.kingbaseES.Select<ToUpd3Pk>().Where(a => a.name.StartsWith("nick")).Count());
        }
