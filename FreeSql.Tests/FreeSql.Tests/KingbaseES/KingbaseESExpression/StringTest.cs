...
namespace FreeSql.Tests.KingbaseESExpression
{
    public class StringTest
    {
        ...
        public void StringJoin()
        {
            ...
            fsql.Insert(new[] { new StringJoin01 { name = "����" }, new StringJoin01 { name = "�Ϻ�" }, new StringJoin01 { name = "����" }, }).ExecuteAffrows();
        ...
        public void Format()
        {
            var item = g.kingbaseES.GetRepository<Topic>().Insert(new Topic { Clicks = 101, Title = "�����й���101", CreateTime = DateTime.Parse("2020-7-5") });
...
WHERE (a.""ID"" = {item.Id})", sql);
        ...
        {
            //3�� {} ʱ��Arguments ���������Ƿֿ���
            //4�� {} ʱ��Arguments[1] ֻ�ܽ������������Ȼ�������� NewArray []
            var item = g.kingbaseES.GetRepository<Topic>().Insert(new Topic { Clicks = 101, Title = "�����й���101", CreateTime = DateTime.Parse("2020-7-5") });
            var sql = select.WhereDynamic(item).ToSql(a => new
            {
