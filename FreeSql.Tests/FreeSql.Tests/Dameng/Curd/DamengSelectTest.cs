...
namespace FreeSql.Tests.Dameng
{
    public class DamengSelectTest
    {
        ...
        public void Lazy()
        {
            var tags = g.dameng.Select<Tag>().Where(a => a.Parent.Name == "xxx")
                .LeftJoin(a => a.Parent_id == a.Parent.Id)
                .ToSql();

            var songs = g.dameng.Select<Song>().Limit(10).ToList();
        }
        ...
        public void ToDataTable()
        {
            ...
            //Assert.Equal(1, g.dameng.Insert<TopicInserts>().AppendData(items.First()).ExecuteAffrows());
            Assert.Equal(11, g.dameng.Insert<TopicInserts>().AppendData(items).ExecuteAffrows());

            //items = Enumerable.Range(0, 9989).Select(a => new TopicInserts { Title = "newtitle" + a, CreateTime = DateTime.Now }).ToList();
            //Assert.Equal(9989, g.dameng.Insert<TopicInserts>(items).ExecuteAffrows());
...
WHERE (((to_char(a.""ID"")) in (SELECT b.""TITLE"" 
    FROM ""TB_TOPIC22"" b)))", subquery);
        ...
        public void Include_OneToMany2()
        {
            ...
            var at1 = g.dameng.Select<TiOtmModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
            ...
            var at11 = g.dameng.Select<TiOtmModel11>()
                .LeftJoin(a => a.model2id == a.model2.id)
        ...
        public void Include_OneToChilds()
        {
            ...
            tag1.Id = (int)g.dameng.Insert(tag1).ExecuteIdentity();
            var tag1_1 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_1.Id = (int)g.dameng.Insert(tag1_1).ExecuteIdentity();
            var tag1_2 = new Tag
            {
                Parent_id = tag1.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag1_2.Id = (int)g.dameng.Insert(tag1_2).ExecuteIdentity();
            ...
            tag2.Id = (int)g.dameng.Insert(tag2).ExecuteIdentity();
            var tag2_1 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_1.Id = (int)g.dameng.Insert(tag2_1).ExecuteIdentity();
            var tag2_2 = new Tag
            {
                Parent_id = tag2.Id,
                Ddd = DateTime.Now.Second,
            ...
            tag2_2.Id = (int)g.dameng.Insert(tag2_2).ExecuteIdentity();

            var tags0 = g.dameng.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var tags1 = g.dameng.Select<Tag>()
            ...
            var tags11 = g.dameng.Select<Tag>()
            ...
            var tags22 = g.dameng.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.dameng.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var atags0 = g.dameng.Select<Tag>()
                .Include(a => a.Parent)
                .Where(a => a.Id == tag1.Id || a.Id == tag2.Id)
                .ToList();

            var atags1 = g.dameng.Select<Tag>()
            ...
            var atags2 = g.dameng.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
                    then => then.Include(a => a.Parent).IncludeMany(a => a.Songs))
                .Include(a => a.Parent)
                .IncludeMany(a => a.Songs.Select(b => new Song { Id = b.Id, Title = b.Title }))
            ...
            var atags3 = g.dameng.Select<Tag>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags11 = g.dameng.Select<Tag>()
            ...
            var atags22 = g.dameng.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.dameng.Select<Tag>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
        ...
        public void Include_ManyToMany()
        {
            ...
            tag3.Id = (int)g.dameng.Insert(tag3).ExecuteIdentity();
            ...
            song1.Id = (int)g.dameng.Insert(song1).ExecuteIdentity();
            var song2 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song2.Id = (int)g.dameng.Insert(song2).ExecuteIdentity();
            var song3 = new Song
            {
                Create_time = DateTime.Now,
            ...
            song3.Id = (int)g.dameng.Insert(song3).ExecuteIdentity();

            g.dameng.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.dameng.Insert(new Song_tag { Song_id = song2.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.dameng.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag1.Id }).ExecuteAffrows();
            g.dameng.Insert(new Song_tag { Song_id = song1.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.dameng.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag2.Id }).ExecuteAffrows();
            g.dameng.Insert(new Song_tag { Song_id = song3.Id, Tag_id = tag3.Id }).ExecuteAffrows();

            var songs1 = g.dameng.Select<Song>()
                .IncludeMany(a => a.Tags)
            ...
            var songs2 = g.dameng.Select<Song>()
                .IncludeMany(a => a.Tags,
            ...
            var tags3 = g.dameng.Select<Song_tag>()
            ...
            var songs11 = g.dameng.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            ...
            var songs22 = g.dameng.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1),
            ...
            var tags33 = g.dameng.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            var asongs2 = g.dameng.Select<Song>()
                .IncludeMany(a => a.Tags.Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags3 = g.dameng.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
            ...
            var asongs11 = g.dameng.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }))
                .Where(a => a.Id == song1.Id || a.Id == song2.Id || a.Id == song3.Id)
                .ToList();
            Assert.Equal(3, songs11.Count);
            ...
            var asongs22 = g.dameng.Select<Song>()
                .IncludeMany(a => a.Tags.Take(1).Select(b => new Tag { Id = b.Id, Name = b.Name }),
            ...
            var atags33 = g.dameng.Select<Song_tag>()
                .Include(a => a.Tag.Parent)
        ...
        {
            g.dameng.Select<ToDel1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.dameng.Select<ToDel1Pk>().Count());
            g.dameng.Insert(new[] {
            ...
            Assert.Equal(2, g.dameng.Select<ToDel1Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.dameng.Select<ToDel1Pk>().Count());
            Assert.Equal(3, g.dameng.Select<ToDel1Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.dameng.Select<ToDel2Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.dameng.Select<ToDel2Pk>().Count());
            g.dameng.Insert(new[] {
            ...
            Assert.Equal(2, g.dameng.Select<ToDel2Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.dameng.Select<ToDel2Pk>().Count());
            Assert.Equal(3, g.dameng.Select<ToDel2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.dameng.Select<ToDel3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.dameng.Select<ToDel3Pk>().Count());
            g.dameng.Insert(new[] {
            ...
            Assert.Equal(2, g.dameng.Select<ToDel3Pk>().Where(a => a.name.StartsWith("name")).ToDelete().ExecuteAffrows());
            Assert.Equal(3, g.dameng.Select<ToDel3Pk>().Count());
            Assert.Equal(3, g.dameng.Select<ToDel3Pk>().Where(a => a.name.StartsWith("nick")).Count());
        }
        ...
        {
            g.dameng.Select<ToUpd1Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.dameng.Select<ToUpd1Pk>().Count());
            g.dameng.Insert(new[] {
            ...
            Assert.Equal(2, g.dameng.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
            Assert.Equal(5, g.dameng.Select<ToUpd2Pk>().Count());
            Assert.Equal(5, g.dameng.Select<ToUpd2Pk>().Where(a => a.name.StartsWith("nick")).Count());

            g.dameng.Select<ToUpd3Pk>().ToDelete().ExecuteAffrows();
            Assert.Equal(0, g.dameng.Select<ToUpd3Pk>().Count());
            g.dameng.Insert(new[] {
            ...
            Assert.Equal(2, g.dameng.Select<ToUpd3Pk>().Where(a => a.name.StartsWith("name")).ToUpdate().Set(a => a.name, "nick?").ExecuteAffrows());
