...
WHERE (((cast(a.""Id"" as character)) in (SELECT b.""Title"" 
    ...
    limit 0,10)))", subquery);
        ...
        {
            var fsql = g.sqlite;
            fsql.CodeFirst.SyncStructure<VM_District_Parent>();
            fsql.CodeFirst.SyncStructure<ts_dyfilter_enum01>();
            ...
            sql = fsql.Select<ts_dyfilter_enum01>().WhereDynamicFilter(JsonConvert.DeserializeObject<DynamicFilterInfo>(@"
{
  ...
  [
    {
      ""Field"" : ""MyRawSql FreeSql.Tests.Sqlite.DynamicFilterMyCustom, FreeSql.Tests.Provider.Sqlite.Data"",
      ""Operator"" : ""Custom"",
